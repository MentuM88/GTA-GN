...
lang_string = {
menu1 = "Ranger un véhicule",
menu2 = "Récupérer un véhicule",
menu3 = "Fermer",
menu4 = "Vehicules",
menu5 = "Options",
menu6 = "Récupérer",
...
menu9 = "Vendre",
menu10 = "~g~E~s~ pour vendre le véhicule a 50% du prix d'achat",
menu11 = "Update le vehicule",
menu12 = "Suivant",
state1 = "Sortir",
state2 = "Entrer",
...
text4 = "Ce n'est pas votre véhicule",
text5 = "Véhicule rangé",
text6 = "Pas de véhicule sur la zone",
text7 = "Véhicule vendu",
text8 = "Véhicule acheté, bonne route",
text9 = "Argent insuffisant",
...
function vRPgt.despawnGarageVehicle(vtype,max_range)
  ...
  if vehicle then
    ...
    if GetDistanceBetweenCoords(x,y,z,px,py,pz,true) < max_range then -- check distance with the vehicule
      ...
      Citizen.InvokeNative(0xEA386986E786A54F, Citizen.PointerValueIntInitialized(vehicle[3]))
	  TriggerEvent("vrp_garages:setVehicle", vtype, nil)
      vRP.notify({"~g~Vehicule stocké."})
    else
      vRP.notify({"~r~Trop loin du véhicule."})
    end
  else
