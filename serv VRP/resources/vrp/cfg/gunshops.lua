...
["Paleto"] = {
 ...
 --   ["WEAPON_FLAREGUN"] = {"Flaregun",35,0,""},
  ...
  ["policeloadout"] = {
    ...
    ["WEAPON_SMG"] = {"Mitr. Legere",10000,5,""},
    ["WEAPON_CARBINERIFLE"] = {"Mitr. moyenne",10000,5,""},
    ["WEAPON_MG"] = {"MG",20000,25,""}
  },
  ["Cadet"] = {
  ...
  ["Special Import"] = {
    ...
    ["WEAPON_SPECIALCARBINE"] = {"Carabine speciale",10,0,""},
    ["WEAPON_ASSAULTSHOTGUN"] = {"Pompe d'assault",10,0,""},
	  ["WEAPON_BULLPUPRIFLE"] = {"Bullpup Rifle",100,45,""},
    ["WEAPON_ADVANCEDRIFLE"] = {"Carabine",100,50,""},
    ["WEAPON_SNSPISTOL"] = {"Pistol sns",20,7,""},
    ["WEAPON_MOLOTOV"] = {"Molotv",50,500,""},
    ["WEAPON_MUSKET"] = {"Musket",50,10,""},
    ["WEAPON_SMOKEGRENADE"] = {"Smoke Grenade",50,500,""},
    ["WEAPON_ASSAULTSMG"] = {"Assault SMG",50,5,""},
   ["WEAPON_COMBATPDW"] = {"Combat PDW",70,5,""},
  ["WEAPON_MACHINEPISTOL"] = {"Machine Pistol",70,5,""},
    ["WEAPON_CROWBAR"] = {"Crowwbar",70,0,""},
    ["WEAPON_GOLFCLUB"] = {"Golf club",30,0,""},
    ["WEAPON_SWITCHBLADE"] = {"Blade",100,0,""},
    ["WEAPON_MACHETE"] = {"Machete",150,0,""},
   ["WEAPON_MARKSMANPISTOL"] = {"Marksman Pistol",10,5,""},
   ["WEAPON_SNSPISTOL"] = {"Pistol",20,5,""},
   ["WEAPON_COMPACTRIFLE"] = {"Mini SMG",50,10,""},
   ["WEAPON_ASSAULTRIFLE"] = {"Assault Rifle",60,50,""},
   ["WEAPON_CARBINERIFLE"] = {"Carabineri Rifle",60,50,""},
   ["WEAPON_GRENADE"] = {"Grenade",30,350,""},
   ["WEAPON_MOLOTOV"] = {"Molotv",10,100,""},
   ["WEAPON_FLARE"] = {"Flare",10,10,""},
   ["WEAPON_GUSENBERG"] = {"Gusenberg MG",50,5,""},
   ["WEAPON_MG"] = {"MG",100,75,""},
   ["WEAPON_COMBATMG"] = {"Combat MG",10,100,""},
   ["WEAPON_MARKSMANPISTOL"] = {"Marksman Pistol",10,7,""},
   ["WEAPON_SNSPISTOL"] = {"Pistol",20,7,""},
   ["WEAPON_MARKSMANRIFLE"] = {"Marksman Rifle",10,100,""},
    ["WEAPON_SNIPERRIFLE"] = {"Sniper Rifle",20,75,""},
    ["WEAPON_HEAVYSNIPER"] = {"Heavy Rifle",40,150,""},
    ["WEAPON_BULLPUPRIFLE"] = {"Bullpup Rifle",50,45,""},
   ["WEAPON_ADVANCEDRIFLE"] = {"Carabine",60,50,""},
   ["WEAPON_SPECIALCARBINE"] = {"Special Carabine",60,50,""},
   ["WEAPON_MOLOTOV"] = {"Molotv",10,100,""},
    ["WEAPON_FLARE"] = {"Flare",10,10,""},
    ["WEAPON_SAWNOFFSHOTGUN"] = {"Saw Shotgun",30,65,""},
   ["WEAPON_PUMPSHOTGUN"] = {"Pump Shotgun",70,20,""},
   ["WEAPON_BULLPUPSHOTGUN"] = {"BullUp Shotgun",10,30,""},
    ["WEAPON_HEAVYSHOTGUN"] = {"Heavy Shotgun",50,50,""},
   ["WEAPON_ASSAULTSHOTGUN"] = {"Assault Shotgun",15,50,""},
   ["WEAPON_GRENADELAUNCHER_SMOKE"] = {"Grenade Launcher",50,3500,""}
