...
["Paleto"] = {
   ...
   -- ["WEAPON_APPISTOL"] = {"Ap Pistol",7500,2,""},
    ...
    ["WEAPON_MICROSMG"] = {"Mini SMG",150000,5,""},
  ...
  --  ["WEAPON_MACHINEPISTOL"] = {"Machine Pistol",7500,5,""},
   ...
   -- ["WEAPON_COMPACTRIFLE"] = {"Mini SMG",5500,10,""},
    --["WEAPON_ASSAULTRIFLE"] = {"Assault Rifle",165000,50,""},
 ...
 --   ["WEAPON_FLAREGUN"] = {"Flaregun",35,0,""},
  ...
  ["policeloadout"] = {
    ...
    ["WEAPON_COMBATPDW"] = {"Mitr. Legere",30000,0,""},
    ["WEAPON_SPECIALCARBINE"] = {"Mitr. moyenne",50000,0,""}
  },
  ["Cadet"] = {
    _config = {permissions = {"Cadet.loadshop"}},
    ["WEAPON_PETROLCAN"] = {"Petrol",0,0,""},
    --["WEAPON_PUMPSHOTGUN"] = {"Pump Shotgun",0,0,""},
  ["WEAPON_FLAREGUN"] = {"Flare Gun",0,0,""},
  ["WEAPON_FLASHLIGHT"] = {"Flashlight",0,0,""},
  ...
  ["Special Import"] = {
    _config = {permissions = {"achat.armes"}},
    ["WEAPON_SPECIALCARBINE"] = {"Carabine speciale",100000,0,""},
    ["WEAPON_ASSAULTSHOTGUN"] = {"Pompe d'assault",160000,0,""},
	  ["WEAPON_BULLPUPRIFLE"] = {"Bullpup Rifle",100000,45,""},
    ["WEAPON_ADVANCEDRIFLE"] = {"Carabine",100000,50,""},
    ["WEAPON_SNSPISTOL"] = {"Pistol sns",25000,7,""},
    ["WEAPON_MOLOTOV"] = {"Molotv",500,500,""},
    ["WEAPON_MUSKET"] = {"Musket",50000,10,""},
    ["WEAPON_SMOKEGRENADE"] = {"Smoke Grenade",500,500,""}
...
cfg.gunshops = {
  ...
  {"Special Import", 811.65, -2157.19, 29.62}, 
