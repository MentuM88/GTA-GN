...
local itemtr_study = {
  ...
  recipes = {
    ...
    ["Mathematics book"] = { -- action name
      description="lire un livre de mathemathique", -- action description
      in_money=0, -- money taken per unit
      out_money=0, -- money earned per unit
      reagents={}, -- items taken per unit
      products={}, -- items given per unit
...
cfg.slot_types = {
  ["mansion"] = {
    {
      ...
      {"chest",-808.51202392578,175.12515258789,76.740737915039, _config = {weight=350}},
  ...
  ["Modern_Apt"] = {
    {
      ...
      {"chest",-260.3044128418,-710.51483154297,71.03263092041, _config = {weight=300}},
  ...
  ["mansion2"] = {
    {
      ...
      {"chest",-11.527637481689,516.53375244141,174.62814331055, _config = {weight=350}},
  ...
  ["Expensive_flat"] = {
    {
      ...
      {"chest",-170.91767883301,486.65267944336,137.44346618652, _config = {weight=400}},
   ...
   ["Rich_flat"] = {
  {
      ...
      {"chest",118.02893829346,548.17034912109,184.09687805176, _config = {weight=500}},
  ...
  ["Normal_flat"] = {
  {
      ...
      {"chest",338.19, 436.88, 141.77, _config = {weight=250}},
      {"wardrobe",334.45, 428.5, 145.57},
      {"gametable",330.65, 426.8, 148.99},
    --  {"itemtr", _config = itemtr_study, 338.52639770508,430.09219360352,145.5708},
  ...
  ["basic_flat"] = {
    {
      ...
      {"chest",-773.718078613281,325.144409179688,223.266357421875, _config = {weight=300}},
   ...
   -- {"itemtr", _config = itemtr_laboratory, -772.294372558594,328.913177490234,223.261581420898}
    },
    {
      ...
      {"chest",-782.118591308594,332.147399902344,207.629608154297, _config = {weight=300}},
   ...
   -- {"itemtr", _config = itemtr_laboratory, -783.788635253906,328.553985595703,207.625396728516}
    },
    {
      ...
      {"chest",-782.66015625,332.523284912109,160.010223388672, _config = {weight=300}},
   ...
   -- {"itemtr", _config = itemtr_laboratory, -784.178588867188,328.916839599609,160.006057739258}
    },
    {
      ...
      {"chest",-604.427001953125,57.0807762145996,108.035743713379, _config = {weight=300}},
    ...
    },
    {
      ...
      {"chest",-1457.28601074219,-529.699523925781,69.565315246582, _config = {weight=300}},
   ...
   -- {"itemtr", _config = itemtr_laboratory, -1456.35876464844,-533.55029296875,69.5607528686523}
    },
    {
      ...
      {"chest",-1457.3740234375,-529.737854003906,56.9376449584961, _config = {weight=300}},
  ...
  --  {"itemtr", _config = itemtr_laboratory, -1456.32409667969,-533.43701171875,56.9333839416504}
    },
    {
      ...
      {"chest",-914.79296875,-375.26416015625,109.448974609375, _config = {weight=300}},
   ...
   -- {"itemtr", _config = itemtr_laboratory, -914.430541992188,-379.17333984375,109.444869995117}
    },
    {
      ...
      {"chest",-915.268737792969,-375.818084716797,85.4891815185547, _config = {weight=300}},
   ...
   -- {"itemtr", _config = itemtr_laboratory, -915.567504882813,-371.905731201172,85.4850234985352}
    },
    {
      ...
      {"chest",-466.566558837891,-700.528991699219,77.0956268310547, _config = {weight=400}},
    ...
    },
    {
      ...
      {"chest",-469.077453613281,-697.664672851563,53.4144515991211, _config = {weight=400}},
  ...
  ["other_flat"] = {
    {
      ...
      {"chest",-766.744384765625,328.375,211.396545410156, _config = {weight=700}},
    ...
    },
    {
      ...
      {"chest",-621.323669433594,54.2074241638184,97.5995330810547, _config = {weight=700}},
    ...
    },
    {
      ...
      {"chest",-1466.57763671875,-528.339294433594,73.4436492919922, _config = {weight=700}},
    ...
    },
    {
      ...
      {"chest",-926.693176269531,-377.596130371094,113.674102783203, _config = {weight=700}},
  ...
  ["plantation_flat"] = {
    {
      ...
      {"chest",1396.7132568359,3604.9682617188,38.941928863525, _config = {weight=700}},
  ...
  ["rail_flat"] = {
    {
      {"entry",1006.967, -3102.079, -39.0035},
      {"chest",1010.967, -3112.079, -39.0035, _config = {weight=2000}},
      {"wardrobe",1020.967, -3102.079, -39.0035},
      {"gametable",1035.967, -3102.079, -39.0035}
    }
  },
  ["paleto"] = {
    {
      {"entry",-1908.024, -573.4244,19.09722},
      {"chest",-1911.9273681641, -569.71649169922, 19.097215652466, _config = {weight=500}},
      {"wardrobe",-1911.9273681641, -570, 19.097215652466},
      {"gametable",-1921.9273681641, -570, 19.097215652466}
    }
  },

  ["gouv1"] = {
    {
      {"entry", 912.76892089844,1250.6534423828,366.11932373047},
      {"chest",939.91180419922,1234.3238525391,374.09957885742, _config = {weight=5000}},
      {"wardrobe",941.86486816406,1238.1082763672,374.10070800781},
      {"gametable",944.03112792969,1245.4686279297,374.09954833984}
    }
  },

  ["villasand"] = {
    {
      {"entry", 2171.9860839844,3909.6135253906,33.709980010986},
      {"chest",2175.5891113281,3910.140625,37.076591491699, _config = {weight=5000}},
      {"wardrobe",2191.5720214844,3907.54296875,37.096584320068},
      {"gametable",2179.138671875,3911.9489746094,37.086540222168}
    }
  },

  ["villavine"] = {
    {
      {"entry", -2504.3076171875,756.01904296875,303.39920043945},
      {"chest",-2499.0310058594,775.69293212891,303.39953613281, _config = {weight=10000}},
      {"wardrobe",-2511.0842285156,781.34936523438,303.39953613281},
      {"gametable",-2522.173828125,753.66937255859,307.84671020508}
    }
  },

  ["police"] = {
    {
      {"entry", 469.41098022461,-1022.3131713867,28.286558151245},
      {"chest",471.06924438477,-1013.6978759766,41.566562652588, _config = {weight=2000}},
      {"wardrobe",472.0881652832,-1017.0120239258,41.566558837891},
      {"gametable",480.02239990234,-1020.661315918,41.566581726074}
    }
  },

  ["hangar2"] = {
    {
      {"entry", 1104.12, -3100.04,-39},
      {"chest",1088.5, -3101.6, -39, _config = {weight=10000}},
      {"wardrobe",1087.44, -3099.33, -39},
      {"gametable",1088.27, -3103, -39}
    }
  },

    ["barmotards"] = {
    {
      {"entry",-572.28552246094,293.17071533203,79.176681518555},
      {"chest",-571.94165039063,288.99545288086,79.17658996582, _config = {weight=5000}},
      {"wardrobe",-573.81079101563,293.52520751953,79.17658996582},
      {"gametable",-571.95159912109,289.9367980957,79.17658996582}
    }
  },

    ["courtier"] = {
    {
      {"entry",-553.40142822266,5349.7758789063,72.301773071289},
      {"chest",-554.68872070313,5326.4389648438,73.599563598633, _config = {weight=10000}},
      {"wardrobe",-552.27691650391,5348.4775390625,74.743064880371}
    }
  },

  ["plantation_flat_2"] = {
    {
      {"entry",2437.41,4974.2,46.83},
      {"chest",2432.1650390625,4963.0649414063,46.936447143555, _config = {weight=1000}},
...
cfg.homes = {
  ...
  ["Entrepot"] = {
    slot = "rail_flat",
    entry_point = {803.62,-1666.15,30.86},
    buy_price = 350000,
    sell_price = 100000,
    max = 100,
    blipid=374,
  ...
  ["Country Ranch'"] = {
    ...
    entry_point = {2433.49,4977.86,46.57},
    buy_price = 200000,
    sell_price = 180000,
    max = 2,
    blipid=374,
  ...
  ["Paleto"] = {
    slot = "paleto",
    entry_point = {-8.74, 6652.97, 31.11},
    buy_price = 200000,
    sell_price = 100000,
    max = 2,
    blipid=374,
  ...
  ["Hangar stock"] = {
    slot = "hangar2",
    entry_point = {1182.92, -3288.87, 5.53},
    buy_price = 250000,
    sell_price = 200000,
    max = 2,
    blipid=374,
  ...
  ["Villa Sandy"] = {
    slot = "villasand",
    entry_point = {2169.0278320313,3906.6413574219,33.710689544678},
    buy_price = 5000000,
    sell_price = 3000000,
    max = 1,
    blipid=350,
  ...
  ["Villa Hauteurs"] = {
    slot = "villavined",
    entry_point = {-2500.5524902344,753.77764892578,303.39920043945},
    buy_price = 10000000,
    sell_price = 6000000,
    max = 1,
    blipid=350,
  ...
  ["Appart Milice"] = {
    slot = "police",
    entry_point = {469.63537597656,-1019.286315918,27.961923599243},
    buy_price = 500000,
    sell_price = 3000000,
    max = 5,
   -- blipid=374,
  ...
  ["Gouvernement"] = {
    slot = "gouv1",
    entry_point = {909.63824462891,1251.5694580078,366.11926269531},
    buy_price = 5000000,
    sell_price = 3000000,
    max = 1,
    blipid=419,
    ...
    ["Bar Motards"] = {
    slot = "barmotards",
    entry_point = {-568.62872314453,291.35705566406,79.176612854004},
    buy_price = 350000,
    sell_price = 200000,
    max = 1,
  --  blipid=374,
  --  blipcolor=5
   ...
   ["Courtier"] = {
    slot = "courtier",
    entry_point = {-601.36016845703,5300.6098632813,70.214416503906},
    buy_price = 100000,
    sell_price = 50000,
    max = 1,
  --  blipid=374,
