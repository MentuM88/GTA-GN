...
cfg.groups = {
  ...
  ["Pêcheur"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Vous êtes un pêcheur."}) end
	},
  ...
  ["Secours"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Vous faites partie des Secours"}) end
	},
    "emergency.revive",
    "emergency.heal",
	"police.pc",
  ...
  ["Apotre"] = {
    _config = { gtype = "job",
  onspawn = function(player) vRPclient.notify(player,{"Vous faites partie du Culte"}) end
  },
  "emergency.revive",
  "emergency.paycheck"
  },
  ...
  ["Mechanic"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Vous êtes un mécanicien."}) end
	},
    "vehicle.repair",
    "vehicle.replace",
    "repair.service",
  ...
  ["UBER"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Vous êtes un UBER."}) end
	},
    "uber.service",
	"uber.vehicle",
	"uber.paycheck"
...
--},
  ["chomeur"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Vous êtes sans emploi, trouvez en un !!!"}) end
	},
	"citizen.paycheck"
  },
  ["Livreur"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Vous êtes livreur."}) end
	},
  ...
  ["Convoyeur"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"Vous êtes convoyeur."}) end
	},
...
--CUSTOM
  ...
  ["Unicorn"] = { 
  _config = { gtype = "job",    
  onspawn = function(player) vRPclient.notify(player,{"Propietaire de l'unicorn"}) end
  },
   "unicorn.whitelisted",
   "craft.unicorn",
   "unicorn.paycheck"
  ...
  ["Bar des Motards"] = {
  _config = { gtype = "job",
  onspawn = function(player) vRPclient.notify(player,{"Propietaire du bar des motards"}) end
  },
     "motards.whitelisted",
     "motards.paycheck",
     "craft.motards"
  ...
  ["Employé BM"] = {
  _config = { gtype = "job",
  onspawn = function(player) vRPclient.notify(player,{"Employé du bar des motards"}) end
  },
     "motards.whitelisted",
     "motards.paycheck",
     "craft.motards"
  ...
  ["Gourou"] = {
  _config = { gtype = "job",
  onspawn = function(player) vRPclient.notify(player,{"Gourou"}) end
  },
   "gourou.whitelisted",
   "emergency.revive",
   "emergency.heal",
  ...
  ["Converti"] = {
  _config = { gtype = "job",
  onspawn = function(player) vRPclient.notify(player,{"Vous êtes dans une se....dans un culte"}) end
  },
   "motards.paycheck",
   "craft.gourou"
  },
...
["Soldat"] = {
  ...
  ["Mecanicien"] = {
    _config = { gtype = "job",
  onspawn = function(player) vRPclient.notify(player,{"Vous êtes un mecano."}) end
  },
    "vehicle.repair",
    "vehicle.replace",
    --"repair.service",
  ...
  onspawn = function(player) vRPclient.notify(player,{"Vous êtes gérant du Casino."}) end
    ...
    ["Garagiste"] = {
    _config = { gtype = "job",
  onspawn = function(player) vRPclient.notify(player,{"Vous êtes un garagiste."}) end
  },
    "vehicle.repair",
    "vehicle.replace",
    "repair.service",
...
["Agent Municipal"] = {
    _config = { gtype = "job",
onspawn = function(player) vRPclient.notify(player,{"Vous êtes maintenant Agent Municipal."}) end
  },
   "police.paycheck",
  "uber.service",
  "uber.vehicle",
  ...
  ["Ouvrier FA"] = {
    _config = { gtype = "job",
  onspawn = function(player) vRPclient.notify(player,{"Vous êtes maintenant Ouvrier."}) end
  },
  "craft.armes",
  "motards.paycheck"
  },
  ["Fabricant d'armes"] = {
    _config = { gtype = "job",
  onspawn = function(player) vRPclient.notify(player,{"Vous êtes maintenant Fabricant d'armes."}) end
  },
  "achat.armes",
  "craft.armes",
  "motards.paycheck"
