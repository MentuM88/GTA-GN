...
TriggerEvent('esx_phone:registerNumber', 'deltasecu', _U('alert_armurier'), true, true)
TriggerEvent('esx_society:registerSociety', 'armurier', 'Delta Secu', 'society_armurier', 'society_armurier', 'society_armurier', {type = 'public'})
...
RegisterServerEvent('esx_armurierjob:confiscatePlayerItem')
AddEventHandler('esx_armurierjob:confiscatePlayerItem', function(target, itemType, itemName, amount)
...
RegisterServerEvent('esx_armurierjob:handcuff')
AddEventHandler('esx_armurierjob:handcuff', function(target)
  TriggerClientEvent('esx_armurierjob:handcuff', target)
end)

RegisterServerEvent('esx_armurierjob:drag')
AddEventHandler('esx_armurierjob:drag', function(target)
  local _source = source
  TriggerClientEvent('esx_armurierjob:drag', target, _source)
end)

RegisterServerEvent('esx_armurierjob:putInVehicle')
AddEventHandler('esx_armurierjob:putInVehicle', function(target)
  TriggerClientEvent('esx_armurierjob:putInVehicle', target)
end)

RegisterServerEvent('esx_armurierjob:OutVehicle')
AddEventHandler('esx_armurierjob:OutVehicle', function(target)
    TriggerClientEvent('esx_armurierjob:OutVehicle', target)
end)
...
ESX.RegisterServerCallback('esx_armurierjob:getVehicleInfos', function(source, cb, plate)
