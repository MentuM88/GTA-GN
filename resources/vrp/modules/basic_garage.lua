...
-- open nearest vehicle
local function ch_open(player,choice)
  local user_id = vRP.getUserId(player)
  if user_id ~= nil then
    -- anim and repair
...
vRP.registerMenuBuilder("main", function(add, data)
  ...
  if user_id ~= nil then
    ...
    if vRP.hasPermission(user_id, "vehicle.open") then
      choices[lang.vehicle.open.title()] = {ch_open, lang.vehicle.open.description()}
    end
