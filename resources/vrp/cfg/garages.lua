...
cfg.garage_types = {
  ...
  ["sandy"] = {
    ...
    ["rentalbus"] = {"Bus Loc",0, "bus de loc"},
  },
...
--[[  
 ...
 ----------   
  ...
  ["Police Helicopters"] = {
    _config = {vtype="car",radius=5.1,permissions={"police.vehicle"}},
    ["polmav"] = {"Maverick",0, "emergency4"}
  },
   ["EMS Helicopters"] = {
    _config = {vtype="car",radius=5.1,permissions={"emergency.vehicle"}},
    ["supervolito2"] = {"EMS",0, "emergency5"},
    ["maverick"] = {"EMS",0, "emergency6"}
  ...
  ["airH"] = {
    _config = {vtype="car",blipid=43,blipcolor=17},
     ["frogger"] = {"Helicopter",300000, "frogger"},
     ["volatus"] = {"Helicopter",300000, "volatus"},
     ["cargobob"] = {"Helicopter",1000000, "cargobob"}
  }, 
  ["uber"] = {
...
cfg.garages = {
  ...
  {"funboats",1503, 3887.39, 28.7},
  {"funboats",1170.14,-2724,-0.70},
  {"sandy",1613.76,3837.54,34.19},
