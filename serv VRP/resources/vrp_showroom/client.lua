...
["compacts"] = {
			...
			buttons = {
				...
				{name = "Dilettante V2", costs = 30000, description = {}, model = "dilettante2"},
				...
				{name = "Savestra", costs = 500000, description = {}, model = "savestra"},
			}
		},
		["coupes"] = {
			title = "coupes",
		...
		["sports"] = {
			...
			buttons = {
				...
				{name = "Lynx", costs = 735000, description = {}, model = "lynx"},
				...
				{name = "Elegy", costs = 1500000, description = {}, model = "elegy2"},
				{name = "Futo", costs = 200000, description = {}, model = "futo"},
				{name = "Neon", costs = 1000000, description = {}, model = "Neon"},
				{name = "Pariah", costs = 1000000, description = {}, model = "pariah"},
				{name = "Raiden", costs = 2000000, description = {}, model = "raiden"},
				{name = "Raptor", costs = 1000000, description = {}, model = "raptor"},
				{name = "Revolter", costs = 1000000, description = {}, model = "revolter"},
				{name = "Ruston", costs = 1000000, description = {}, model = "ruston"},
				--[[{name = "Schwartzer", costs = 500000, description = {}, model = "schwartzer"},--]]
				{name = "Specter", costs = 500000, description = {}, model = "specter"},
				{name = "Specter racing", costs = 1000000, description = {}, model = "specter2"},
				{name = "Sentinel 3", costs = 500000, description = {}, model = "sentinel3"},
			}
		},
		["sportsclassics"] = {
			...
			buttons = {
				...
				{name = "Manana", costs = 65000, description = {}, model = "manana"},
				{name = "Monroe", costs = 65000, description = {}, model = "monroe"},
				{name = "Peyote", costs = 65000, description = {}, model = "peyote"},
				{name = "Tornado", costs = 65000, description = {}, model = "tornado"},
				{name = "Tornado 2", costs = 85000, description = {}, model = "tornado2"},
				{name = "Tornado 3", costs = 105000, description = {}, model = "tornado5"},
				{name = "Stromberg SM", costs = 5000000, description = {}, model = "stromberg"},
				{name = "Turismo classique", costs = 650000, description = {}, model = "turismo2"},
				{name = "Viseris", costs = 1000000, description = {}, model = "viseris"},
				{name = "Comet 5", costs = 1000000, description = {}, model = "comet5"},
			}
		},
		["supers"] = {
			title = "supers",
			...
			buttons = {
				...
				{name = "Subaru", costs = 200000, description = {}, model = "ySbrImpS11"},
				{name = "Audi RS6", costs = 200000, description = {}, model = "rs6"},
				...
				{name = "GP1", costs = 1750000, description = {}, model = "gp1"},
				{name = "Infernus", costs = 440000, description = {}, model = "infernus"},
				{name = "Nero racing", costs = 1950000, description = {}, model = "nero2"},
				{name = "penetrator", costs = 1850000, description = {}, model = "penetrator"},
				{name = "Rocket voltic", costs = 4750000, description = {}, model = "voltic2"},
				...
				{name = "Vagner", costs = 2000000, description = {}, model = "vagner"},
--[[				{name = "Visione", costs = 2000000, description = {}, model = "visione"},--]]
				{name = "X80 Proto", costs = 2700000, description = {}, model = "prototipo"},
				{name = "Zentorno", costs = 725000, description = {}, model = "zentorno"},
				{name = "Autarch", costs = 2000000, description = {}, model = "autarch"},
				{name = "SC1", costs = 3000000, description = {}, model = "sc1"},
				{name = "Z190", costs = 3000000, description = {}, model = "z190"},
				{name = "Nero", costs = 1000000, description = {}, model = "nero"},
			}
		},
		["muscle"] = {
			title = "muscle",
			...
			buttons = {
				...
				{name = "Buccaneer Custo", costs = 40000, description = {}, model = "buccaneer2"},
				{name = "Chino", costs = 225000, description = {}, model = "chino"},
				{name = "Chino Custo", costs = 250000, description = {}, model = "chino2"},
				{name = "Duke O'Death", costs = 6000000, description = {}, model = "dukes2"},
				{name = "Coquette BlackFin", costs = 695000, description = {}, model = "coquette3"},
				{name = "Dominator", costs = 35000, description = {}, model = "dominator"},
				{name = "Dominator Racing", costs = 45000, description = {}, model = "dominator2"},
				{name = "Dukes", costs = 62000, description = {}, model = "dukes"},
				{name = "Gauntlet", costs = 32000, description = {}, model = "gauntlet"},
				{name = "Gauntlet racing", costs = 32000, description = {}, model = "gauntlet2"},
				{name = "Lurcher", costs = 300000, description = {}, model = "lurcher"},
				{name = "Hotknife", costs = 90000, description = {}, model = "hotknife"},
				{name = "Hermes", costs = 3000000, description = {}, model = "Hermes"},
				{name = "Faction", costs = 36000, description = {}, model = "faction"},
				{name = "Faction custo1", costs = 50000, description = {}, model = "faction2"},
				{name = "Faction custo2", costs = 60000, description = {}, model = "faction3"},
				...
				{name = "Virgo custo", costs = 205000, description = {}, model = "virgo2"},
				{name = "Vigero", costs = 21000, description = {}, model = "vigero"},
				{name = "Phoenix", costs = 50000, description = {}, model = "phoenix"},
				{name = "Ruiner", costs = 500000, description = {}, model = "ruiner"},
				{name = "Voodoo", costs = 100000, description = {}, model = "voodoo2"},
			}
		},
		["offroad"] = {
			title = "offroad",
			...
			buttons = {
				...
				{name = "Blazer v2", costs = 9000, description = {}, model = "blazer2"},
				{name = "Blazer v3", costs = 10000, description = {}, model = "blazer3"},
				{name = "Brawler", costs = 500000, description = {}, model = "brawler"},
				{name = "Bubsta 6x6", costs = 249000, description = {}, model = "dubsta3"},
				{name = "Dune Buggy", costs = 20000, description = {}, model = "dune"},
				{name = "Dune Buggy cosplay", costs = 50000, description = {}, model = "dune2"},
				{name = "Rebel", costs = 22000, description = {}, model = "rebel2"},
				{name = "Sandking", costs = 38000, description = {}, model = "sandking"},
				{name = "Sandking XL", costs = 50000, description = {}, model = "sandking2"},
				{name = "The Liberator", costs = 400000, description = {}, model = "monster"},
				{name = "Trophy Truck", costs = 400000, description = {}, model = "trophytruck"},
				{name = "Bodhi", costs = 65000, description = {}, model = "bodhi2"},
				{name = "Injection", costs = 65000, description = {}, model = "bfinjection"},
				{name = "mesa", costs = 100000, description = {}, model = "mesa"},
				{name = "Rancher", costs = 65000, description = {}, model = "rancherxl"},
				{name = "Kamacho", costs = 500000, description = {}, model = "Kamacho"},
				{name = "Riata", costs = 500000, description = {}, model = "riata"},
			}
		},
		["suvs"] = {
			title = "suvs",
			...
			buttons = {
				...
				{name = "Dubsta", costs = 100000, description = {}, model = "dubsta"},
				{name = "Fq2", costs = 250000, description = {}, model = "fq2"},
				{name = "Habanero", costs = 65000, description = {}, model = "habanero"},
				{name = "Mesa", costs = 65000, description = {}, model = "mesa"},
				{name = "Patriot", costs = 400000, description = {}, model = "Patriot"},
				{name = "Serrano", costs = 65000, description = {}, model = "serrano"},
				{name = "Streiter", costs = 500000, description = {}, model = "streiter"},
			}
		},
		["vans"] = {
			title = "vans",
			...
			buttons = {
				...
				{name = "Camper", costs = 60000, description = {}, model = "camper"},
				...
				{name = "Pony", costs = 60000, description = {}, model = "pony"},
				--{name = "Speedo", costs = 80000, description = {}, model = "speedo"},
				{name = "Surfer", costs = 11000, description = {}, model = "surfer"},
				{name = "Youga", costs = 16000, description = {}, model = "youga"},
				{name = "Benson", costs = 100000, description = {}, model = "benson"},
				{name = "Hauler", costs = 150000, description = {}, model = "hauler"},
				{name = "Packer", costs = 150000, description = {}, model = "packer"},
				{name = "Barracks", costs = 400000, description = {}, model = "barracks"},
				{name = "Biff", costs = 100000, description = {}, model = "biff"},
				{name = "Mule", costs = 100000, description = {}, model = "mule"},
				{name = "Mule2", costs = 100000, description = {}, model = "mule2"},
				{name = "Mule3", costs = 100000, description = {}, model = "mule3"},
				{name = "Pounder", costs = 150000, description = {}, model = "pounder"},
				{name = "stockade", costs = 300000, description = {}, model = "stockade"},
				{name = "Slamvan", costs = 400000, description = {}, model = "slamvan2"},
				{name = "Yosemite", costs = 200000, description = {}, model = "yosemite"},
			}
		},
		["sedans"] = {
			title = "sedans",
			...
			buttons = {
				...
				{name = "Cognoscenti(Armored)", costs = 1500000, description = {}, model = "cognoscenti2"},
				...
				{name = "Emperor", costs = 50000, description = {}, model = "emperor"},
				...
				{name = "Romero", costs = 100000, description = {}, model = "romero"},
		...
		["motorcycles"] = {
			...
			buttons = {
				...
				{name = "Shotaro", costs = 665000, description = {}, model = "shotaro"},
				...
				{name = "Chimera", costs = 400000, description = {}, model = "chimera"},
				...
				{name = "Fcr", costs = 220000, description = {}, model = "fcr"},
				{name = "manchez", costs = 120000, description = {}, model = "manchez"},
				{name = "Nightblade", costs = 1000000, description = {}, model = "nightblade"},
				{name = "Sanctus", costs = 1900000, description = {}, model = "sanctus"},
