...
function SlotMenu()
  ClearMenu()
  Menu.addTitle("Machine a sous")
  Menu.addButton("~h~LANCER","Spin",nil)
...
local moneymachine_slot = {
  { ['x'] = 930.14, ['y'] = 56.37, ['z'] = 80.76 },
  { ['x'] = 931.19, ['y'] = 57.57, ['z'] = 80.59 },
  { ['x'] = 932.57, ['y'] = 59.86, ['z'] = 80.2 },
  { ['x'] = 934.44, ['y'] = 62.63, ['z'] = 79.7 },
}
...
Citizen.CreateThread(function()
  for k,v in ipairs(moneymachine_slot)do
    ...
    AddTextComponentString("Machines à sous")
...
Citizen.CreateThread(function()
  while true do
    ...
    if not Menu.hidden then
      ...
      drawText(0.55,  0.42+0.5, 1.0,1.0,0.6,'~g~Jetons~w~'..tostring(money),255,0,0,255,7)
    end
    Menu.renderGUI()
  end
      end
