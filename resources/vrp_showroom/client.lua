...
["compacts"] = {
		...
		["supers"] = {
			...
			buttons = {
				...
				{name = "Autarch", costs = 5000000, description = {}, model = "autarch"},
				{name = "Comet 5", costs = 3000000, description = {}, model = "comet5"},
				{name = "GT500", costs = 2000000, description = {}, model = "gt500"},
				{name = "Hermes", costs = 3000000, description = {}, model = "Hermes"},
				{name = "Kamacho", costs = 4000000, description = {}, model = "Kamacho"},
				{name = "Neon", costs = 5000000, description = {}, model = "Neon"},
				{name = "Pariah", costs = 5000000, description = {}, model = "pariah"},
				{name = "Raiden", costs = 6000000, description = {}, model = "raiden"},
				{name = "Revolter", costs = 6000000, description = {}, model = "revolter"},
				{name = "Riata", costs = 3000000, description = {}, model = "riata"},
