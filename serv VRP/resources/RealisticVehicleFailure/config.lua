...
cfg = {
	deformationMultiplier = 7,					-- How much should the vehicle visually deform from a collision. Range 0.0 to 10.0 Where 0.0 is no deformation and 10.0 is 10x deformation. -1 = Don't touch. Visual damage does not sync well to other players.
	...
	weaponsDamageMultiplier = 3,				-- How much damage should the vehicle get from weapons fire. Range 0.0 to 10.0, where 0.0 is no damage and 10.0 is 10x damage. -1 = don't touch
...
repairCfg = {
	mechanics = {
	--	{name="Mechanic", id=446, r=10.0, x=-337.0,  y=-135.0,  z=39.0},	-- LSC Burton
	--	{name="Mechanic", id=446, r=10.0, x=-1155.0, y=-2007.0, z=13.0},	-- LSC by airport
	--	{name="Mechanic", id=446, r=10.0, x=734.0,   y=-1085.0, z=22.0},	-- LSC La Mesa
	--	{name="Mechanic", id=446, r=10.0, x=1177.0,  y=2640.0,  z=37.0},	-- LSC Harmony
	--	{name="Mechanic", id=446, r=10.0, x=108.0,   y=6624.0,  z=31.0},	-- LSC Paleto Bay
	...
	fixMessages = {
		...
		"Vous avez enlevé de la rouille de la bougie",
	...
	noFixMessages = {
		...
		"Vous vous êtes assuré que le ruban adhésif tenait toujours le moteur ensemble",
		"Vous avez augmenté le volume de la radio, il a juste couvert les étranges bruits du moteur",
		"Vous avez ajouté un anti-rouille sur le tube d'allumage, cela n'a fait aucune différence",
