...
m.messages = {   
    'Consultez les règles du serveur sur ^1http://gardenoire.fr',
    'Rejoignez le DISCORD pour suivre et contribuer ^4https://discord.me/GardeNoire',
    'Ce Tchat est HRP ^7Utilisez le avec Parcimonie',
    'Pas de ^6Freekill / Spawnkill ',
